...
# include "tcpcat/deps/asio/detail/socket_select_interrupter.hpp"
#elif defined(ASIO_HAS_EVENTFD)
# include "tcpcat/deps/asio/detail/eventfd_select_interrupter.hpp"
#else
# include "tcpcat/deps/asio/detail/pipe_select_interrupter.hpp"
#endif
