...
# include "deps/asio/detail/socket_select_interrupter.hpp"
#elif defined(ASIO_HAS_EVENTFD)
# include "deps/asio/detail/eventfd_select_interrupter.hpp"
#else
# include "deps/asio/detail/pipe_select_interrupter.hpp"
#endif
